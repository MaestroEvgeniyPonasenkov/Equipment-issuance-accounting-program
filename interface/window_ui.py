...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu.addAction(self.action_email)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_2.setTitle(_translate("MainWindow", "Экспорт таблиц"))
        self.menu_3.setTitle(_translate("MainWindow", "Настройки"))
        self.action_email.setText(_translate("MainWindow", "Добавить данные почты"))
