...
class Ui_NewRequest(object):
    def setupUi(self, NewRequest):
        ...
        self.cab_line = QtWidgets.QLineEdit(NewRequest)
        self.cab_line.setInputMethodHints(QtCore.Qt.ImhNone)
        self.cab_line.setClearButtonEnabled(True)
        self.cab_line.setObjectName("cab_line")
        self.gridLayout.addWidget(self.cab_line, 4, 1, 1, 1)
